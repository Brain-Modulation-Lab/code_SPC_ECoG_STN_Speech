% [p, observeddifference, effectsize] = permutation_diffTest_indsamples(sample1, sample2, permutations [, varargin])
%
...
function [p, observeddifference, effectsize] = permutation_diffTest_indsamples(sample1, sample2, permutations, varargin)
% parsing input
p = inputParser;
