function [curr_spks, store] = calc_binLen_selectSpikes_simplified(idcs, w, spikes_dataLen, nSpikes, store, halves, trialHalf)
...
idcs1 = bsxfun(@plus, idcs(:,w), repmat(0:400, size(idcs,1), 1));
...
idcs2 = bsxfun(@plus, idcs(:,w), repmat(-400:0, size(idcs,1), 1));
